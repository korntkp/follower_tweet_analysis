...
def extract_diff_ret_or_fol(source_path, choose_str, is_log_delta_retweet_param, is_log_delta_follower_param):
    # Open file
    list1 = []
...
for each_choice in follower_choices:
    for each_topic in topics:
        for each_fold in folds:
            ...
            list_diff_ret = extract_diff_ret_or_fol(source_path, 'retweet', is_log_delta_retweet, is_log_delta_follower)
            # print("Extract - retweet - Success!!")
            list_diff_fol = extract_diff_ret_or_fol(source_path, each_choice, is_log_delta_retweet, is_log_delta_follower)
